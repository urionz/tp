...
<div class="admin-content">
	<ol class="am-breadcrumb">
		<li><a href="<?php echo U('Fhk/YsList','','');?>">应收清单</a></li>
		<li class="am-active">列表</li>
		<li><a href="<?php echo U('Fhk/YsDetail');?>">明细</a></li>
		<li><a href="<?php echo U('Fhk/YsList','','');?>/action/export">导出</a></li>
	</ol>
	...
	<table class="am-table am-table-striped am-table-bordered am-text-sm am-table-hover">
		...
		<?php if(is_array($out)): $i = 0; $__LIST__ = $out;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><?php echo floor($vo['Yqjs']);?></td>
					<td><?php echo ($vo['MaxTime']); ?></td>
					<td><?php echo number_format($vo['ResultMoney'],2,'.',',');?></td>
					<td><?php echo number_format($vo['agree_hk'],2,'.',',');?></td>
					<td><?php echo number_format($vo['OneWeek'],2,'.',',');?></td>
					<td><?php echo number_format($vo['OneMonth'],2,'.',',');?></td>
					<td><?php echo number_format($vo['ThreeMonth'],2,'.',',');?></td>
					<td><?php echo number_format($vo['OutOfThreeMonth'],2,'.',',');?></td>
					<td><?php echo ($vo["OneWeekZb"]); ?></td>
					<td><?php echo ($vo["OneMonthZb"]); ?></td>
					<td><?php echo ($vo["ThreeMonthZb"]); ?></td>
					<td><?php echo ($vo["OutOfThreeMonthZb"]); ?></td>
					<td><?php echo number_format($vo['Lx'],2,'.',',');?></td>
					<td><?php echo number_format($vo['Bj'],2,'.',',');?></td>
					<td><?php echo number_format($vo['CalcFx'],2,'.',',');?></td>
		...
		<?php if($Sum['CCount'] != 0): ?><tr>
				...
				<td><?php echo number_format($Sum['agree_hkSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['OnyWeekSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['OnyMonthSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['ThreeMonthSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['OutOfThreeMonthSum'],2,'.',',');?></td>
				<td><?php echo round($Sum['OnyWeekSum']/$Sum['ResultMoneySum']*100,2).'%';?></td>
				<td><?php echo round($Sum['OnyMonthSum']/$Sum['ResultMoneySum']*100,2).'%';?></td>
				<td><?php echo round($Sum['ThreeMonthSum']/$Sum['ResultMoneySum']*100,2).'%';?></td>
				<td><?php echo round($Sum['OutOfThreeMonthSum']/$Sum['ResultMoneySum']*100,2).'%';?></td>
				<td><?php echo number_format($Sum['LxSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['BjSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['CalcFxSum'],2,'.',',');?></td>
			</tr><?php endif; ?>
	</table>
