...
<div class="admin-content">
	<ol class="am-breadcrumb">
		<li><a href="<?php echo U('Fhk/DsList','','');?>">待收清单</a></li>
		<li class="am-active">列表</li>
		<li><a href="<?php echo U('Fhk/DsList','','');?>/action/export">导出</a></li>
	</ol>
	...
	<table class="am-table am-table-striped am-table-bordered am-text-sm am-table-hover">
		...
		<?php if(is_array($out)): $i = 0; $__LIST__ = $out;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><?php echo floor($vo['Dqjs']);?></td>
				<td><?php echo (date('Y-m-d',$vo['MaxDate'])); ?></td>
				<td><?php echo number_format($vo['ResultMoney'],2,'.',',');?></td>
				<td><?php echo number_format($vo['OneMonth'],2,'.',',');?></td>
				<td><?php echo number_format($vo['ThreeMonth'],2,'.',',');?></td>
				<td><?php echo number_format($vo['SixMonth'],2,'.',',');?></td>
				<td><?php echo number_format($vo['OneYear'],2,'.',',');?></td>
				<td><?php echo number_format($vo['OutOfOneYear'],2,'.',',');?></td>
				<td><?php echo round($vo['OneMonth']/$vo['ResultMoney']*100,2).'%';?></td>
				<td><?php echo round($vo['ThreeMonth']/$vo['ResultMoney']*100,2).'%';?></td>
				<td><?php echo round($vo['SixMonth']/$vo['ResultMoney']*100,2).'%';?></td>
				<td><?php echo round($vo['OneYear']/$vo['ResultMoney']*100,2).'%';?></td>
				<td><?php echo round($vo['OutOfOneYear']/$vo['ResultMoney']*100,2).'%';?></td>
				<td><?php echo number_format($vo['Bj'],2,'.',',');?></td>
				<td><?php echo number_format($vo['Lx'],2,'.',',');?></td>
		...
		<?php if($Sum['CCount'] != 0): ?><tr>
				...
				<td><?php echo number_format($Sum['OneMonthSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['ThreeMonthSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['SixMonthSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['OneYearSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['OutOfOneYearSum'],2,'.',',');?></td>
				<td><?php echo round($Sum['OneMonthSum']/$Sum['ResultMoneySum']*100,2).'%';?></td>
				<td><?php echo round($Sum['ThreeMonthSum']/$Sum['ResultMoneySum']*100,2).'%';?></td>
				<td><?php echo round($Sum['SixMonthSum']/$Sum['ResultMoneySum']*100,2).'%';?></td>
				<td><?php echo round($Sum['OneYearSum']/$Sum['ResultMoneySum']*100,2).'%';?></td>
				<td><?php echo round($Sum['OutOfOneYearSum']/$Sum['ResultMoneySum']*100,2).'%';?></td>
				<td><?php echo number_format($Sum['BjSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['LxSum'],2,'.',',');?></td>
			</tr><?php endif; ?>
	</table>
