...
<div class="admin-content">
	<ol class="am-breadcrumb">
		<li><a href="<?php echo U('Fhk/AlreadyList','','');?>">已收清单</a></li>
		<li class="am-active">列表</li>
		<li><a href="<?php echo U('Fhk/AlreadyList','','');?>/action/export">导出</a></li>
	</ol>
	<div class="am-form-group">
    
    <form action="<?php echo U('Fhk/AlreadyList');?>" method="post">
    <label>开始日期</label>
	...
	<table class="am-table am-table-striped am-table-bordered am-text-sm am-table-hover" >
		...
		<?php if(is_array($out)): $i = 0; $__LIST__ = $out;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><?php echo number_format($vo['FacHb'],2,'.',',');?></td>
				<td><?php echo number_format($vo['FacHx'],2,'.',',');?></td>
				<td><?php echo number_format($vo['AgreeHb'],2,'.',',');?></td>
				<td><?php echo number_format($vo['AgreeHx'],2,'.',',');?></td>
				<td><?php echo number_format($vo['HzBj'],2,'.',',');?></td>
				<td><?php echo number_format($vo['HzLx'],2,'.',',');?></td>
		...
		<?php if($Sum['CCount'] != 0): ?><tr>
				...
				<td><?php echo number_format($Sum['FacHbSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['FacHxSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['AgreeHbSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['AgreeHxSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['HzBjSum'],2,'.',',');?></td>
				<td><?php echo number_format($Sum['HzLxSum'],2,'.',',');?></td>
